  ...
  <body>
    <div id="navigation">
      ...
      <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
        ...
        <input type="image" src="https://www.paypal.com/en_US/i/btn/btn_donate_SM.gif" width="100" height="30" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
